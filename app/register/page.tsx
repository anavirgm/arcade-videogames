  ...
  return (
    <div className="min-h-screen space-background relative overflow-hidden flex flex-col items-center justify-center p-8">
      ...
      <div className="w-full max-w-md bg-black/80 p-8 rounded-lg border-2 border-purple-500">
        <h2 className="text-3xl font-bold mb-6 text-center arcade-title text-white">Regístrate</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full start-button">Registrarse</Button>
        </form>
        <p className="mt-4 text-center text-sm text-purple-300">
          ¿Ya tienes una cuenta?{' '}
          <Link href="/login" className="text-purple-400 hover:text-purple-300 hover-glow">
            Inicia sesión
          </Link>
        </p>
      </div>
