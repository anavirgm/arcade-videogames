...
export default function GalagaGame() {
  ...
  return (
    <div className="min-h-screen space-background relative overflow-hidden flex flex-col items-center justify-center p-8">
      ...
      <div className="w-full max-w-4xl bg-black/80 p-8 rounded-lg border-2 border-blue-500">
        <h2 className="text-3xl font-bold mb-6 text-center arcade-title text-blue-400">Galaga</h2>
        <div className="aspect-video bg-black border-4 border-blue-500 rounded-lg flex items-center justify-center">
          <p className="text-blue-400 text-2xl arcade-title">Juego de Galaga aquí</p>
        </div>
        <div className="mt-6 flex justify-between items-center">
          <Link href="/games" className="flex items-center text-white hover:text-blue-400 transition-colors">
            <ArrowLeftIcon className="mr-2" />
            Volver a la selección de juegos
          </Link>
          <button className="start-button bg-blue-500 text-black hover:bg-blue-400">Iniciar Juego</button>
        </div>
      </div>
    </div>
  )
