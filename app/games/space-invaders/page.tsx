...
export default function SpaceInvadersGame() {
  ...
  return (
    <div className="min-h-screen space-background relative overflow-hidden flex flex-col items-center justify-center p-8">
      ...
      <div className="w-full max-w-4xl bg-black/80 p-8 rounded-lg border-2 border-green-500">
        <h2 className="text-3xl font-bold mb-6 text-center arcade-title text-green-400">Space Invaders</h2>
        <div className="aspect-video bg-black border-4 border-green-500 rounded-lg flex items-center justify-center">
          <p className="text-green-400 text-2xl arcade-title">Juego de Space Invaders aquí</p>
        </div>
        <div className="mt-6 flex justify-between items-center">
          <Link href="/games" className="flex items-center text-white hover:text-green-400 transition-colors">
            <ArrowLeftIcon className="mr-2" />
            Volver a la selección de juegos
          </Link>
          <button className="start-button bg-green-500 text-black hover:bg-green-400">Iniciar Juego</button>
        </div>
      </div>
    </div>
  )
